...
<?php
if(!$user->is_logged_in()){ header('Location: dummyposes.php'); }
 ?>
<html lang="en">
	            	...
	            	<div class="col-sm-12 portfolio-masonry">
		                <div class="portfolio-box web-design">
		                	<div class="portfolio-box-container">
			                	    <img src="assets/img/poses/Peacock.jpg">
		                ...
		                <div class="portfolio-box web-design">
		                	<div class="portfolio-box-container">
			                	    <img src="assets/img/poses/Eagle.jpg">
			                	<div class="portfolio-box-text">
			                		<h3>Eagle pose</h3>
		                ...
		                <div class="portfolio-box web-design">
		                	<div class="portfolio-box-container">
			                	    <img src="assets/img/poses/Noose.jpg">
			                	<div class="portfolio-box-text">
			                		<h3>Noose Pose</h3>
		                ...
		                <div class="portfolio-box web-design">
		                	<div class="portfolio-box-container">
                                <a href="staff-pose.html">
			                	    <img src="assets/img/poses/TwoFoot.jpg">
                                </a>
			                	<div class="portfolio-box-text">
			                	  <a href="staff-pose.php">	<h3>Upward Facing Two-Foot Pose</h3></a>
		                ...
		                <div class="portfolio-box web-design">
		                	<div class="portfolio-box-container">
                                <a href="crane-pose.html">
			                	    <img src="assets/img/poses/Crane.jpg">
                                </a>
			                	<div class="portfolio-box-text">
			                	<a href="crane-pose.php">	<h3>Crane Pose</h3></a>
		                ...
		                <div class="portfolio-box web-design">
		                	<div class="portfolio-box-container">
                                <a href="dummyposes.php">
			                	    <img src="assets/img/poses/BoundAngle.jpg">
                                </a>
			                	<div class="portfolio-box-text">
